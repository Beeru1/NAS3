...
function validate()
{
	document.forms[0].OTPCode.value=OTPCode;
	
	if(OTPCode=="")
	{	
		alert("Please enter value for OTP Code ");
		document.forms[0].OTPCode.focus();
		return false;
	}
	if(OTPCode !="" )
		{	
		   if(OTPCode.length <8 || !isInteger(document.forms[0].OTPCode) )
			{
			  alert("Please enter 8 digit OTP Code");
			  document.forms[0].OTPCode.select();
			  return false;
			}
...
<body>
<html:form action="/OTPlogin" focus="OTPCode">
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0" style="background-image:url(./images/bg_1.jpg); background-repeat:repeat-y; background-position:center top;">
  <tr>
    <td width="177" height="91" align="right"><img src="common/images/lms_logo.png" alt="LMS" width="158" height="44" /></td>
    <td width="470">&nbsp;</td>
      ...
      <tr>
        ...
        <td colspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="8">&nbsp;</td> 
            <td width="246" align="left"><html:password name="loginForm"  property="OTPCode" style="WIDTH: 60%" maxlength="25" /></td>
          </tr>
		  ...
		  <tr>
            ...
            <td width="8">   </td>
            <td width="246" align="left"><html:image align="center"  property="submit" onclick="validate();" src="./images/submit_button.jpg" /></td>
          </tr>
