...
<script language="javascript"> 
  ...
  var redirectUrl='<%= request.getAttribute("RedirectLink")%>';
function Redirect()
{
...
<body onload="javascript:setTimeout('Redirect()');">
<!--  
<table width="778" border="0" align="center" cellpadding="0" cellspacing="0" style="background-image:url(./images/bg_1.jpg); background-repeat:repeat-y; background-position:center top;">
  ...
  <tr>
    <td colspan="3" align="center"><img src="./images/oops.png" alt="" width="770" height="300" /></td>
  </tr>
  <tr>
...
<!--   <tr>
  ...
  <tr>
    <td height="265" colspan="3" align="center"><table width="400" border="0" cellpadding="0" cellspacing="0" bgcolor="#D9EEF6">
      <h3><strong><center><font color="red" size='5'><html:errors /></font></center> </strong></h3><br>
      
      <h5><center><font color="blue" size='3'>Window will be redirected to EasyAccess within 5 seconds...........</font></center></h5>
    </table></td>
  </tr>
  <tr>
