package com.ibm.nas.dto.webservice;
import com.ibm.nas.common.Constants;

public class LeadCaptureServiceFirstVersDO {
	...
	private String dob;
	private String paymentAmtDue; //EXTRA_PARAM1
	private String paymentStatus;//EXTRA_PARAM6
	private String paymentCollected;//EXTRA_PARAM2
	private String paymentType; //EXTRA_PARAM5
	private String competitorChosen;
	...
	public String getPaymentAmtDue() {
		return paymentAmtDue;
	}
	public void setPaymentAmtDue(String paymentAmtDue) {
		int size = Constants.OTHER_SIZE;
		if(paymentAmtDue !=null && paymentAmtDue.length() > size) 
			paymentAmtDue = paymentAmtDue.substring(0, size-1 );
		this.paymentAmtDue = paymentAmtDue;
	}
	...
	public String getCompetitorChosen() {
		return competitorChosen;
	}
	public void setCompetitorChosen(String competitorChosen) {
		this.competitorChosen = competitorChosen;
	}
	...
	public String getPartExisting() {
		return PartExisting;
	}
	public void setPartExisting(String partExisting) {
		int size = 15;
		if(partExisting!=null&&partExisting.length()>size)
			partExisting=partExisting.substring(0, size-1);
		this.PartExisting = partExisting;
	}
	/*public String getExistingPart() {
		return existingPart;
	}
	public void setExistingPart(String existingPart) {
		int size =0;// Constants.EXIST_PART;
